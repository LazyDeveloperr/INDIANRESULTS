<header>
  <!-- Navbar -->
  <nav class="navbar navbar-expand-lg shadow-md py-2 bg-dark relative flex items-center w-full justify-between">
    <div class="px-6 w-full flex flex-wrap items-center justify-between">
      ...
      <div class="navbar-collapse grow items-center" id="navbarSupportedContentY">
        <ul class="navbar-nav mr-0 lg:flex lg:flex-row">
          <li class="nav-item">
